...
import { Brain, Lock, Mail, User, ArrowRight, Sparkles, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-slate-400 mt-1">Start generating AI insights and machine learning models</p>
        </div>
